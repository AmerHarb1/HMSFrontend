...
export function TableTable(props){
    ...
    const lnk = props.lnk;
    const detailLnk = props.detailLnk;
        ...
        //    setTabDataNoChar(tabData);
            const cols = Object.keys(tabData[0])
                ...
                .map((key) => {
                    ...
                    const buildDetailState = (record, rowData) => ({
                            ...
                            return(
                                <a  className='AddLinkButton'  
                                    ...
                                    onClick={() => {
                                        ...
                                        setDetailTable(true);
                                        setDetailId(record.id ?? record.code)
                                    }}
                                                                    >
                                    {display}
    ...
    useEffect(() => {
        getData(0, 10, '', 'asc', lnkId);
        setDetailTable(null);   //used to reset the tab if another tab is clicked and both are TableTable
    }, [lnk, lnkId]);
    ...
    return(
        <div>
            <Space size={15} direction="vertical">
               ...
               : <AddTable lnk={detailLnk} entryView="view" modifyView="view"  lnkId = {detailId} backLink={backLink}/>   
                }
